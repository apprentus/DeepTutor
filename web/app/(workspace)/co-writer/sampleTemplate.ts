...
export const CO_WRITER_SAMPLE_TEMPLATE = `# Encore Co-Writer

> Encore's built-in writing canvas for notes, reports, tutorials, and AI-assisted drafts.
...
- A practical starter draft for Encore product docs and learning content

## Headers (Underline)

Encore Learning Note
=============

Encore Study Outline
-------------
...
The <abbr title="Large Language Model">LLM</abbr> layer powers Encore while the <abbr title="Retrieval Augmented Generation">RAG</abbr> layer provides grounded knowledge support.

### Blockquotes

> Encore helps students turn questions into structured understanding.
>
> "Learn deeply, write clearly.", [Encore](#deeptutor-co-writer)

### Links

[Encore Co-Writer](#deeptutor-co-writer "co-writer section")

[Encore Learning Note](#deeptutor-learning-note)

[Encore Website](#encore-co-writer)
...
> Encore brand mark used inside the co-writer template.
...
op=>operation: Encore analyzes intent
...
${FENCE}seq
Student->Encore: Ask for help
Encore->KnowledgeBase: Load context
Note right of Encore: Collect memory\\nand relevant knowledge
Encore-->Student: Return guided response
Student->>Encore: Request rewrite in co-writer
${FENCE}
